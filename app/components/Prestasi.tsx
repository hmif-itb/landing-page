...
interface LastAchievement{
  lastAchievement : DataAchivement;
}

const Prestasi = ({lastAchievement} : LastAchievement) => {
        ...
        <div className="w-full flex flex-col lg:grid lg:grid-cols-2 md:min-h-[60vh] gap-x-4">
          ...
          <div className="py-4 md:mt-3 text-[11px] md:text-[15px] pr-4 flex justify-center font-poppins text-[#1B1508] font-semibold text-left flex flex-col items-center lg:items-start">
            <p className="text-center lg:text-left">
             Penyelenggara : <br></br>
             {lastAchievement.penyelenggara}
            </p>
            <button className="lg:self-start rounded-[20px] bg-[#966F16] w-[150px] md:w-[300px] h-[27px] md:h-[50px] shadow-1xl mt-5" onClick={()=>router.push("/prestasi")}>
