...
const Prestasi = () => {
  return (
    <div className="relative md:min-h-[90vh] bg-[#F8C249] max-w-screen pt-2">
      ...
      <div className="w-full px-12 mt-8">
        ...
        <div className="w-full flex flex-col md:grid md:grid-cols-2 md:min-h-[60vh] gap-x-4">
          ...
          <div className="py-4 md:mt-3 text-[11px] md:text-[15px] pr-4 flex justify-center font-poppins text-[#1B1508] font-semibold text-left flex flex-col items-center md:items-start">
