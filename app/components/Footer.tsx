...
const Footer = () => {
  return (
    <div className="max-w-screen bg-[#1B1508] md:min-h-[300px] filter drop-shadow-lg flex flex-col md:flex-row items-center px-5 pt-4 shadow-2xl">
      ...
      <div className="block md:hidden max-w-[1/3] w-[148px] h-[97px]">
        <Image src={"/logo-hmif.png"} alt="Logo HMIF" width={148} height={97} />
      </div>
      <div className="hidden md:block max-w-[1/3] w-[343px] h-[225px]">
      ...
      <div className="h-full flex flex-col grid grid-rows-3 items-center ml-8 text-[#FBE3A1]">
        <div className="flex flex-col font-poppins">
          <p className="font-bold text-[11px] md:text-[22px]">Alamat</p>
          <p className="text-[9px] md:text-[13px] mt-2">
            Labtek V Gedung Benny Subianto di ITB, Jl Ganesa 10, Bandung
          </p>
        </div>
        <div className="flex flex-col font-poppins">
          <p className="font-bold text-[11px] md:text-[22px]">Kontak</p>
          <p className="text-[9px] md:text-[13px] mt-1">
      ...
      {/* Paling kanan */}
      <div className="hidden md:flex flex-col absolute right-16 text-right h-full font-poppins font-bold text-[#FBE3A1] pt-5 text-[22px]">
        <div
